...
\todo[inline]{This was originally laid out differently, but it turns out that all the models are just different types of geostatistical mapping}
...
Different types of each model will be looked at and compared in order to select the most suitable candidate for this project. 
...
\todo[inline]{Use hue interpolation for the variable and saturation for the variance?}
