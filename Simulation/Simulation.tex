\chapter{Simulation Environment}\label{simulation}
    ...
    \section{Simulator Options}\label{simulation_simulator_options}
        ...
        \subsection{Simulation Speed Optimisation}\label{simulation_simulator_options_simulation_speed_optimisation}
            ...
            \centerimagewideanywhere{./images/AP_vs_Time_and_Events.png}{An example of how simulation time and events change with the number of access points.}{fig:access_points_vs_time_and_events}\tdi{Replace with matplotlib version}
