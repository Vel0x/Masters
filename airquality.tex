...
\todo[inline]{Do I need this since it was in MPP? And if it comes out can I move the sensors stuff into an appendix or something?}

\todo[inline]{Should probably expand this a little bit (at least for the final report)}
...
\paragraph{Solid State Sensors} \hspace{0pt} \\
